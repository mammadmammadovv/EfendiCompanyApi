...
{
    public static bool ProductionMode { get { return false; } }
    ...
    public static string BaseUrl { get { return ProductionMode ? "https://steam-api.azurewebsites.net" : "https://localhost:5001"; } }
    public static string BaseUIUrl { get { return ProductionMode ? "https://steam-ui.azurewebsites.net" : "http://localhost:3000"; } }
    ...
    public static string ConnStrPattern { get { return ProductionMode ? "Data Source=./wwwroot/AppData/###.db;Mode=ReadWriteCreate;Cache=Shared;" : "Data Source=C:\\Users\\user\\Desktop\\EfendiCompanyApi\\EfendiCompany\\API\\wwwroot\\AppData\\###.db;Mode=ReadWriteCreate;Cache=Shared;"; } }
    ...
    public static string ConnStrDemo { get { return ProductionMode ? "Data Source=./wwwroot/AppData/EfendiDemo.db;Mode=ReadWriteCreate;Cache=Shared;" : "Data Source=C:\\Users\\user\\Desktop\\EfendiCompanyApi\\EfendiCompany\\API\\wwwroot\\AppData\\EfendiDemo.db;Mode=ReadWriteCreate;Cache=Shared;"; } }
